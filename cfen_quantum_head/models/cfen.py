...
class CFEN(nn.Module):
    ...
    """
    def __init__(self, feat_dim, num_obj_classes, num_rel_classes, dm_lambda=0.4, ema_alpha=5e-4, fusion='sum', q_device=None):
        super().__init__()
        ...
        self.rel_head = CFENRelationHead(feat_dim, num_rel_classes, q_device=q_device)
